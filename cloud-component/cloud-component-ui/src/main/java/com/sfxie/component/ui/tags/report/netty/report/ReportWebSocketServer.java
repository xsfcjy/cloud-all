 ...
 * </ul>
 */
public final class ReportWebSocketServer {

    static final boolean SSL = System.getProperty("ssl") != null;
    static final int PORT = Integer.parseInt(System.getProperty("port", SSL? "8443" : "8380"));
    private static ChannelGroup group = null;
    ...
    public void start() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new ReportWebSocketServerInitializer(sslCtx));

            Channel ch = b.bind(PORT).sync().channel();

            new Thread(new ReportTask(group)).start();;
