...
@EnableConfigurationProperties({ MybatisBusinessProperties.class })
// @EnableTransactionManagement
@AutoConfigureAfter(DsCrmBusinessConfiguration.class)
@MapperScan(basePackages = "com.sfxie.sharecloud.apigateway.authentication.dao.business.mapper", sqlSessionFactoryRef = "businessSqlSessionFactory")
public class MybatisBusinessConfiguration extends BaseApplicationConfig {

	@Resource(name = "businessDataSource")
	private DataSource druidDataSource;

	@Resource
	private MybatisBusinessProperties mybatisProperties;
