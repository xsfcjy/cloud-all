...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	 ...
	 */
	/*
	 * public static String getTableFieldName(String dtoName, String
	 * entityClassProperty) { return
	 * ContextHolder.getDBColumnNameByFieldName(dtoName, entityClassProperty); }
	 */
	...
	public static int toInteger(Object object, int defaultValue) {
		return (object != null && isNumeric(object.toString())) ? Integer
	...
	public static Enum<?> transformStringToEnum(Class<? extends Enum> cls,
			String str) {
