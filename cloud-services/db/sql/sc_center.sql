...
CREATE TABLE `sfxie_sys_company` (
  ...
  `company_level` decimal(2,0) DEFAULT NULL COMMENT '公司级别 : 用来控制公司下面管理员的级别。\r\n超级管理员: 值为"上级超级管理的级别+1";\r\n普通用户: 默认值为 -1\r\n\r\n作用:用于创建无限级超级管理员',
...
-- ----------------------------
INSERT INTO `sfxie_sys_company` VALUES ('1', 'test_sfxie', '测试公司1', 'testcompany1', 'test', null, null, null, null, '2', 'sfxie', '2017-05-01 17:21:06', null, null, '1', 'Y', null, null, '-1', '');
INSERT INTO `sfxie_sys_company` VALUES ('2', 'test_sfxie2', '测试公司112', 'testcompany2', 'test', null, null, null, null, '', 'sfxie', '2017-05-01 19:11:41', null, null, '2', 'Y', null, null, '-1', '');
INSERT INTO `sfxie_sys_company` VALUES ('3', 'test_company2', '测试公司新增', null, null, null, null, null, null, '测试公司新增', '', '2017-07-05 15:21:21', null, null, null, 'Y', null, null, null, '');
INSERT INTO `sfxie_sys_company` VALUES ('caaa750f-b3d5-425d-b7b6-04e6b634b13b', 'test_company3', '测试公司322', null, null, null, null, null, null, 'ew1', '', '2017-07-05 15:24:32', null, null, null, 'Y', null, null, null, '');
...
-- ----------------------------
INSERT INTO `sfxie_sys_department` VALUES ('1', 'test_department', '测试部门', 'sfxie', '2017-05-01 19:04:16', null, null, 'Y', '1', null, '1', 'test_sfxie', null, '0');
...
-- ----------------------------
INSERT INTO `sfxie_sys_menu` VALUES ('1', 'sys_org_company', '1', null, '组织架构管理', null, '组织架构管理', null, null, '1', null, null, null, '2017-05-05 08:51:05', 'sfxie', 'Y', null, '0');
INSERT INTO `sfxie_sys_menu` VALUES ('2', 'sys_center_company', '1', null, '公司', '/jsp/center/companyList.jsp', '公司', null, null, '1', '1', null, null, '2017-05-05 08:57:28', 'sfxie', 'Y', null, '0');
INSERT INTO `sfxie_sys_menu` VALUES ('3', 'sys_report', '1', null, '报表展示', '/jsp/report/report.jsp', '报表', null, null, '2', '1', null, null, '2017-05-20 19:24:58', 'sfxie', 'Y', null, '0');
INSERT INTO `sfxie_sys_menu` VALUES ('4', 'sys_report_manager', '1', null, '报表管理', '/jsp/report/reportList.jsp', '报表管理', null, null, '3', '1', null, null, '2017-06-07 08:38:06', 'sfxie', 'Y', null, '0');
...
CREATE TABLE `sfxie_sys_post` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '最后修改时间 : 最后修改时间',
  `update_user` varchar(32) DEFAULT NULL COMMENT '最后修改人 : 最后修改人',
  `company_id` varchar(32) DEFAULT NULL COMMENT '公司主键 : 公司主键',
  `parent_id` varchar(32) DEFAULT NULL COMMENT '父主键 : 关联父主键',
  `is_valid` char(1) DEFAULT NULL COMMENT '是否有效 : 是否有效,Y:是;N:否\r\n控制是否在公司任职有效',
  `create_company_id` varchar(50) DEFAULT NULL COMMENT '创建公司 : 创建公司',
  `partition_company` varchar(8) NOT NULL COMMENT '分区字段 : 分区字段,从用户公司代码字段取值',
  ...
  CONSTRAINT `sfxie_sys_post_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `sfxie_sys_department` (`id_`) ON DELETE NO ACTION ON UPDATE NO ACTION
