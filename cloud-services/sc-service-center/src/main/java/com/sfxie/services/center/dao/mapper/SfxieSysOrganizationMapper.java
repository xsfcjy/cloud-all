...
public interface SfxieSysOrganizationMapper {
    /**
     *  根据主键删除数据库的记录,sfxie_sys_organizition
     *
     * @param id
     */
    ...
    /**
     *  新写入数据库记录,sfxie_sys_organizition
     *
     * @param record
     */
    ...
    /**
     *  动态字段,写入数据库记录,sfxie_sys_organizition
     *
     * @param record
     */
    ...
    /**
     *  根据指定主键获取一条数据库记录,sfxie_sys_organizition
     *
     * @param id
     */
    ...
    /**
     *  动态字段,根据主键来更新符合条件的数据库记录,sfxie_sys_organizition
     *
     * @param record
     */
    ...
    /**
     *  根据主键来更新符合条件的数据库记录,sfxie_sys_organizition
     *
     * @param record
     */
    ...
    /**
     *  根据条件查询数据库记录,sfxie_sys_organizition
     */
