...
public class SfxieSysCompany {
    ...
    /**
     *  是否有效 : 是否有效,Y:是;N:否
控制是否在公司任职有效,所属表字段为sfxie_sys_company.is_valid
     */
...
控制是否在公司任职有效 字段:sfxie_sys_company.is_valid
     *
     * @return sfxie_sys_company.is_valid, 是否有效 : 是否有效,Y:是;N:否
控制是否在公司任职有效
     */
...
控制是否在公司任职有效 字段:sfxie_sys_company.is_valid
     *
     * @param isValid sfxie_sys_company.is_valid, 是否有效 : 是否有效,Y:是;N:否
控制是否在公司任职有效
     */
