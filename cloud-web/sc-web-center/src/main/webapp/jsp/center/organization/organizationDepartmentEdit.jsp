...
<script type="text/javascript">
	...
	function submitDepartmentForm(){
		...
		GoLive.EasyUI.Form.submit({
			...
			restfulId:'departmentId',
			url:'${centerPath}/department',
			...
			success: function(data){
		    	...
		    	GoLive.EasyUI.Form.reset('departmentForm');
            	$('#organizationDepartmentEdit').window('close');
		    }
		});
	}
</script>
   	<div class="golive-easyui-form-div">
	   	<form id="departmentForm" class="easyui-form" method="post" data-options="novalidate:true" action="">
	        ...
	        <div>
	            <label for="departmentCode"><font color="#990000">*</font><spring:message code="page.center.organization.departmentCode" />：</label>
	            <input class="easyui-textbox" style="width:200px;" type="text" name="departmentCode" data-options="required:true"></input>
	        </div>
	        <div>
	            <label for="departmentName"><spring:message code="page.center.organization.departmentName" />：</label>
	            <input class="easyui-textbox" style="width:200px;" type="text" name="departmentName"></input>
	        </div>
	        <div>
   	...
   	<div style="text-align:center;padding:5px;height: 10%;">
    	<a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitDepartmentForm()"><spring:message code="button.save" /></a>
